...
from mvp_orchestrator import (
    ...
    PostgreSQLProfileRepository, make_id,
)
...
def create_app(
    ...
    def get_user(user_id: str) -> dict[str, Any]:
        return success(session_service.getUser(user_id))

    @app.post("/api/v1/user", status_code=201)
    def create_user() -> dict[str, Any]:
        return success(session_service.createUser())
    ...
    @app.postuser("/api/v1/user", status_code=201)
    def create_createUser() -> dict[str, Any]:
        return success(session_service.createUser())
