...
test('formal frontend exposes the pixel visual shell', () => {
  ...
  assert.match(index, /styles\.css\?v=pixel-v10/);
  assert.match(index, /api\.js\?v=pixel-v10/);
  assert.match(index, /flow\.js\?v=pixel-v10/);
  assert.match(index, /app\.js\?v=pixel-v10/);
