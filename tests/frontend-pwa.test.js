...
test('service worker caches the app shell without caching API calls', () => {
  ...
  assert.match(worker, /free-time-agent-pwa-v4/);
  assert.match(worker, /styles\.css\?v=pixel-v10/);
  assert.match(worker, /api\.js\?v=pixel-v10/);
  assert.match(worker, /flow\.js\?v=pixel-v10/);
  assert.match(worker, /app\.js\?v=pixel-v10/);
